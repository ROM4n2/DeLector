...
| 项 | 值 |
|---|---|
| 当前分支 / HEAD | `master` @ tag `v4.6.2`（**已发布**；PR #8/#9/#11/#13/#14/#15/#16/#19/#20/#22/#23 详见版本历史）<br>⚠️ 这一行只写 **tag**、不写 commit SHA：写 SHA 必然指向「本次改动之前」的那个 commit，自己就过期，v4.4.9 那轮为此额外开了 PR #18 去修自指 |
