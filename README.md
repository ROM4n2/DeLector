...
| 平台                 | 版本             | 说明                                                                                                                                                                                                                                      | 下载通道                                                                                    |
| ------------------ | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| 🪟 **Windows x64** | `v4.8.3` 绿色便携版 | 免安装 Python / 零环境依赖，解压双击 `DeLector.exe` 即可秒开                                                                                                                                                                                             | [下载 ZIP 包 (GitHub Releases)](https://github.com/ROM4n2/DeLector/releases/tag/v4.8.3)    |
| 🍎 **macOS**       | `v4.8.3` 免安装包  | 解压运行 `start` 脚本，全自动启动服务与默认浏览器                                                                                                                                                                                                           | [下载 TAR.GZ 包 (GitHub Releases)](https://github.com/ROM4n2/DeLector/releases/tag/v4.8.3) |
| 🐧 **Linux x64**   | `v4.8.3` 便携版   | 全发行版通用，解压运行 `start` 即可使用                                                                                                                                                                                                                | [下载 TAR.GZ 包 (GitHub Releases)](https://github.com/ROM4n2/DeLector/releases/tag/v4.8.3) |
| 📱 **Android**     | `v4.8.3` 独立单机版 | 内嵌 Python 运行时与 spaCy 离线模型，单机独立运行；**支持 arm64-v8a**，CI 钉死签名 keystore 并验签（可覆盖升级）。**v4.8.1 修复 Android 版 routes\_corpus 模块缺失导致引擎启动失败问题；v4.8.2 修复预设文章不 seed 与首次进入服务端初始化阻塞交互无响应问题；v4.8.3 修复** **`main.js`** **窗口回调未定义导致安卓交互全死（页面正常但点击无反应）回归。** | [下载 APK 安装包 (GitHub Releases)](https://github.com/ROM4n2/DeLector/releases/tag/v4.8.3)  |
