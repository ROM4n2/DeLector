...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-270%2F270%20Passed-2EA44F?style=flat-square" alt="Pytest" />
...
| **自动化测试** | `pytest` + `httpx` | 270 单元与集成测试用例保障 (100% Green)，CI 覆盖 md 加载路径与 Android 构建验签 |
