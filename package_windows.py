...
def build_windows():
    ...
    pyinstaller_cmd = [
        ...
        "--hidden-import=delector.core_dict",
        "--hidden-import=delector.core_dict_ext",
        "--hidden-import=delector.prep_dict",
        "--hidden-import=delector.a1_dict",
        "--hidden-import=delector.a1_writing_dict",
        "--hidden-import=delector.a1_hoeren_dict",
        "--hidden-import=delector.a1_lesen_dict",
        "--hidden-import=delector.corpus_dict",
        "--hidden-import=delector.routes_a1",
        "--hidden-import=delector.routes_a2",
        "--hidden-import=delector.routes_a1_hoeren",
        "--hidden-import=delector.routes_a1_lesen",
        "--hidden-import=delector.routes_corpus",
        "--hidden-import=delector.routes_sync",
        "--hidden-import=delector.routes_rtc",
        "--hidden-import=delector.routes_exam",
