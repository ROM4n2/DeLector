...
| 任务 | 文件 | 状态 |
|---|---|---|
| T1 | routes/main.py | pending |
| T2 | core/database.py | pending |
| T3 | encounter + syntax_hard | pending |
| T4 | a1 + lexicon + linguistics | pending |
| T5 | lexicon_merge + server + processor + vocab_stats + tts | pending |
| T6 | 其余 19 文件 | pending |
| T7 | 全仓验收 + 门禁切换 | pending |
